...
export default function DumasRoadEscorts() {
 ...
 { title: " Call Girl", image: "/images/services/ Call Girl.webp", description: " call girl services on Dumas Road", price: "₹19,000+", rating: "4.9" },
 ...
 { title: "Call Girls", image: "/images/services/Call Girls.webp", description: "Professional Call Girls companions on Dumas Road", price: "₹24,000+", rating: "4.8" },
 ...
 escort services on Dumas Road - Coastal charm with sophisticated companionship
 </p>
 ...
 <Image
 src={service.image}
 alt={`${service.title} - Dumas Road Escort Service in Surat`}
 fill
 ...
 <h2 className="text-4xl md:text-5xl font-bold text-pink-700 mb-4">Popular Services in Dumas Road</h2>
 ...
 <p className="text-gray-600 mb-4"> vip companionship service available in Dumas Road</p>
 ...
 <p className="text-gray-600 mb-4"> call girl service available in Dumas Road</p>
 <span className="text-pink-600 font-semibold hover:text-pink-700">View Details →</span>
 </Link>
 ...
 <p className="text-gray-600 mb-4"> hotel escort service available in Dumas Road</p>
 <span className="text-pink-600 font-semibold hover:text-pink-700">View Details →</span>
 </Link>
 ...
 <p className="text-gray-600 mb-4"> travel companion service available in Dumas Road</p>
 <span className="text-pink-600 font-semibold hover:text-pink-700">View Details →</span>
 </Link>
 </div>
 </div>
 ...
 Contact us now for escort services on Dumas Road area
 </p>
