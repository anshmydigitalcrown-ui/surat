...
export default function VesuEscorts() {
  const services = [
    ...
    { title: "Celebrity Look-alike", image: "/images/services/Celebrity Look-alike.webp", description: "Celebrity look-alike companions in Vesu", price: "₹26,000+" },
    { title: "College Girl", image: "/images/services/College Girl.webp", description: "Young college girl companions in Vesu", price: "₹14,000+" },
    { title: "Housewife", image: "/images/services/Housewife.webp", description: "Mature housewife companions in Vesu", price: "₹17,000+" },
    { title: "In-call Service", image: "/images/services/In-call Service.webp", description: "Comfortable in-call services in Vesu", price: "₹16,000+" },
    { title: "Outcall Service", image: "/images/services/Outcall Service.webp", description: "Professional outcall services in Vesu", price: "₹18,000+" },
    { title: "Party Escort", image: "/images/services/Party Escort.webp", description: "Party escort services in Vesu", price: "₹19,000+" },
    { title: "Special Service", image: "/images/services/Special Service.webp", description: "Specialized escort services in Vesu", price: "₹23,000+" },
    { title: "Weekend Special", image: "/images/services/Weekend Special.webp", description: "Weekend special companions in Vesu", price: "₹21,000+" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6">
            {services.map((service, index) => (
              ...
              >
                <div className="relative h-48 sm:h-56 lg:h-64 bg-gradient-to-br from-green-50 to-pink-50">
                  <Image
                    src={service.image}
                    alt={service.title}
                    fill
                ...
                <div className="p-3 sm:p-4 lg:p-6">
                  <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-green-700 mb-2 line-clamp-1">{service.title}</h3>
                  <p className="text-sm text-gray-600 mb-3 sm:mb-4 line-clamp-2">{service.description}</p>
                  <div className="flex justify-between items-center">
                    <span className="text-green-600 font-bold text-sm sm:text-base lg:text-lg">{service.price}</span>
                    <span className="bg-green-600 text-white px-2 sm:px-3 lg:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium hover:bg-green-700 transition-colors duration-300">
                      View Details
                    </span>
                  </div>
                </div>
