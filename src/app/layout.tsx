      ...
      >
        ...
        <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-50">
          ...
          <a
            ...
            className="bg-gradient-to-r from-primary-500 to-accent-600 hover:from-primary-600 hover:to-accent-700 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 group"
