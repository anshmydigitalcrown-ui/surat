...
export const metadata: Metadata = {
 ...
 title: "RashmiKapoor | Best Escort Service in Surat - Call Girls 24/7",
 description: "#1 Escort Service in Surat - Experience luxury with escorts service in Surat. Professional call girls, VIP companions, and sophisticated escort service in Surat available 24/7. Serving Varachha, Adajan, Vesu, Citylight & all locations.",
 keywords: [
 ...
 openGraph: {
 title: "RashmiKapoor | No.1 Best Escort Service Surat - Call Girls 24/7",
 ...
 width: 1200,
 height: 630,
 alt: "RashmiKapoor - Escort Service in Surat",
 },
 ],
 },
 twitter: {
...
export default function RootLayout({
 ...
 "description": " escort service in Surat offering professional companionship",
 "address": {
 "@type": "PostalAddress",
