...
export default function About() {
 ...
 <p className="text-sm text-pink-100"> Quality</p>
 </div>
 <div className="text-center">
 <div className="text-4xl mb-2">🤝</div>
 ...
 icon: '💎',
 title: 'Luxury',
 description: 'Providing experiences that define the standards of luxury service.',
 ...
 <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 drop-shadow-md"> Quality</h3>
 ...
 <p className="text-2xl md:text-3xl text-pink-700 max-w-4xl mx-auto font-medium leading-relaxed">
 Get answers to common questions about our companion services in Surat
 </p>
 </div>
 ...
 Gift vouchers available for experiences. Perfect for special occasions and celebrations.
 </p>
 </div>
 </div>
 </div>
