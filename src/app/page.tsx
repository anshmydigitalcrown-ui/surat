...
export default function Home() {
 ...
 <div>
 <p className="text-pink-600 font-medium text-base sm:text-lg">Escort Service</p>
 </div>
 </div>
 ...
 Experience the best <strong>escort service in Surat</strong> with luxury and sophistication. We offer discreet, professional <strong>escorts service in Surat</strong> tailored to your needs with complete privacy and elegance. call girls and VIP companions available across all Surat locations.
 </p>
 </div>
 ...
 <span className="text-gray-700 text-base sm:text-lg font-medium">24/7 Service Available</span>
 </div>
 <div className="flex items-center space-x-3">
 <div className="w-6 h-6 bg-gradient-to-r from-pink-500 to-rose-600 rounded-full flex items-center justify-center shadow-md flex-shrink-0">
 <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
 ...
 <p className="text-red-600 font-medium text-sm sm:text-base">Escort Service</p>
 </div>
 ...
 alt="RashmiKapoor - Escort Service" 
 fill
 ...
 <Image 
 src={service.image} 
 alt={`${service.title} - Escort Service in Surat`}
 fill
 ...
 <strong>escort service in Surat</strong> available across all major areas - Best escorts service in Surat for every location
 </p>
 </div>
 ...
 <p className="text-lime-100 mb-4"> companions near Majura Gate</p>
 ...
 <p className="text-red-100 mb-4"> services in Magdalla port area</p>
 ...
 <h3 className="text-2xl font-bold text-red-600 mb-6"> Quality</h3>
 <p className="text-red-600 italic leading-relaxed mb-6">
 ...
 <p className="text-2xl font-bold text-pink-800 mb-2">+91 93726 62471</p>
 ...
 <p className="text-sm md:text-base leading-relaxed">Yes, our escort services are available 24/7. We provide round-the-clock assistance to ensure you can book our services at any time that suits your schedule.</p>
 </div>
 </details>
 ...
 <div className="px-4 md:px-6 pb-4 md:pb-6 text-gray-700">
 <p className="text-sm md:text-base leading-relaxed">We offer a wide range of companion services including social events, business meetings, dinner dates, and travel companionship. All services are provided with complete professionalism.</p>
 </div>
 </details>
