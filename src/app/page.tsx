            ...
            <div className="space-y-8 animate-fadeInUp">
              <div className="space-y-4">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-sweet-pink-500 to-light-red-600 rounded-xl flex items-center justify-center shadow-lg">
                ...
                <h2 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
                  Surat&apos;s Most
                  <span className="block bg-gradient-to-r from-sweet-pink-600 to-light-red-600 bg-clip-text text-transparent">
                    Trusted Companion
                  </span>
                  Service
                </h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-gradient-to-r from-sweet-pink-500 to-light-red-500 rounded-full flex items-center justify-center shadow-md">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link 
                  href="/contact" 
                  className="relative bg-gradient-to-r from-sweet-pink-500 via-light-red-500 to-sweet-pink-600 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-center overflow-hidden group"
                >
                ...
                <a 
                  ...
                  className="relative border-2 border-sweet-pink-500 text-sweet-pink-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-sweet-pink-500 hover:text-white transition-all duration-300 text-center flex items-center justify-center space-x-2 group shadow-lg hover:shadow-xl"
                >
