            ...
            <div className="space-y-8 animate-fadeInUp">
              <div className="space-y-4">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-sweet-pink-400 to-light-red-500 rounded-xl flex items-center justify-center">
                    <span className="text-white font-bold text-xl">RK</span>
                  </div>
                  <div>
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-sweet-pink-600 to-light-red-600 bg-clip-text text-transparent">
                      RashmiKapoor
                    </h1>
                    <p className="text-sweet-pink-500 font-medium">Premium Escort Service</p>
                  </div>
                </div>
                
                <h2 className="text-4xl md:text-6xl font-bold text-gray-800 leading-tight">
                  Surat&apos;s Most
                  <span className="block bg-gradient-to-r from-sweet-pink-500 to-light-red-600 bg-clip-text text-transparent">
                    Trusted Companion
                  </span>
                  Service
                </h2>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-sweet-pink-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                    </svg>
                  </div>
                  <span className="text-gray-700 text-lg">24/7 Premium Service Available</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-sweet-pink-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-700 text-lg">Complete Discretion & Privacy</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-sweet-pink-500 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-gray-700 text-lg">Professional & Sophisticated</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link 
                  href="/contact" 
                  className="bg-gradient-to-r from-sweet-pink-500 to-light-red-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-xl hover:scale-105 transition-all duration-300 text-center"
                >
                  Book Consultation
                </Link>
                <a 
                  ...
                  className="border-2 border-sweet-pink-500 text-sweet-pink-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-sweet-pink-500 hover:text-white transition-all duration-300 text-center flex items-center justify-center space-x-2"
                >
            ...
            <div className="relative animate-fadeInUp" style={{animationDelay: '0.3s'}}>
              <div className="relative">
                ...
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="aspect-[3/4] bg-gradient-to-br from-sweet-pink-300 via-light-red-300 to-sweet-pink-400 relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center text-white">
                        ...
                        <h3 className="text-2xl font-bold mb-2">RashmiKapoor</h3>
                        <p className="text-lg opacity-90">Premium Companion</p>
                      </div>
                    </div>
                ...
                {/* Floating Badge */}
                <div className="absolute -top-4 -right-4 bg-sweet-pink-500 text-white px-6 py-3 rounded-2xl shadow-lg transform rotate-12">
