        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.621 5.367 11.988 11.988 11.988s11.987-5.367 11.987-11.988C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.32-1.297C4.198 14.553 3.708 13.402 3.708 12.105s.49-2.448 1.297-3.32C5.936 7.853 7.087 7.363 8.384 7.363s2.448.49 3.32 1.297c.931.931 1.421 2.082 1.421 3.379s-.49 2.448-1.421 3.379c-.872.807-2.023 1.297-3.32 1.297z"/>
                </svg>
              </a>
              <a 
                href="#" 
