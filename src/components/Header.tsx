        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">No.1 Best Escort Service Surat</p>
              </div>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a 
              ...
              className="bg-gradient-to-r from-primary-500 to-accent-600 text-white px-4 py-2 rounded-full hover:shadow-lg hover-glow transition-all duration-300 transform hover:scale-105 flex items-center space-x-2"
            >
